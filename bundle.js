...
/***/ function(module, exports, __webpack_require__) {
	...
	var updateWins = function updateWins(data) {
	  return $.ajax({
...
/***/ function(module, exports, __webpack_require__) {
	...
	var placeMarker = function placeMarker(cell) {
	  $(cell).html(player);
	};

	var isValidMove = function isValidMove(cell) {
	  if ($(cell).html() === "") {
	    return true;
	  } else {
	    return false;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var gameStarts = function gameStarts() {
	...
	var onNewGame = function onNewGame(event) {
	  ...
	  api.newGame().done(newGameSuccess).fail(failure);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onChangePassword = function onChangePassword(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  api.changePassword(data).done(ui.changePassword).fail(ui.failure);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(global) {module.exports = global["getFormFields"] = __webpack_require__(10);
	/* WEBPACK VAR INJECTION */}.call(exports, (function() { return this; }())))
